...
@section('content_header')
    <nav aria-label="breadcrumb" style="font-size: 16pt">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edicion de Recinto</li>
        </ol>
    </nav>
@stop
        ...
        <div class="col-md-6">
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">Editar Recintos</h3>
                </div>
                <div class="card-body" style="display: block">
                    <form action="{{ url('/admin/recintos/'.$recinto->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="nummesas" name="nummesas"
                                        value="{{ $recinto->nummesas }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="numhabilitados">Numero de Habilitados</label>
                                    <input type="number" class="form-control" id="numhabilitados" name="numhabilitados"
                                        value="{{ $recinto->numhabilitados }}">
                                </div>
                            </div>
